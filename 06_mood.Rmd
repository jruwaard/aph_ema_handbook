...
# code snippet 9.1: plotting data over time
library(ggplot2) 
library(emaph)
...
# code snippet 9.2: Plotting multiple variables in one graph
library(ggplot2) 
library(emaph)
...
# code snippet 9.3: Performing a factor analysis
library(dplyr)
library(tibble)
