...
# Code snippet 10.1: Fitting symptom networks.
library(ggplot2)
...
# Code snippet 10.2: plotting symptom networks
...
# Code snippet 10.3: Node Centrality plots.
library(qgraph)
...
```{r mlvarcode}
# Code snippet 10.4: Fitting symptom networks of multiple subjects.
library("mlVAR")
library(methods)
...
# Code snippet 10.5: plotting symptom networks of multiple subjects.
