...
```{r cs13b, out.width = "100%", fig.cap = "SCL-90 depression score, over the study period", fig.asp = .3}
...
```{r}
# code snippet #13c: Running the DFA
...
```{r cs13h, eval = TRUE, out.width = "100%", fig.asp = .4, fig.cap = "Results of the DFA analysis.", warning = FALSE}
