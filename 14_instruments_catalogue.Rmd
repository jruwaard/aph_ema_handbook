...
Currently, EMA assessment protocols are hard-coded in the app. New EMA assessments protocols can be implemented in collaboration with the MoodBuster development team. An online backoffice is in development. Previous studies used an Android version of the EMA app. Cross-platform versions of the app in development.
