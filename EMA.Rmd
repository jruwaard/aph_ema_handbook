...
In EMA research, we distinguishe two forms of data collection: 1) 'Active
...
discussed.
  ...
  - **Part II** focuses on EMA study design (Chapter \@ref(methods), and EMA 
  data management (Chapter \@ref(datamanagement)).
