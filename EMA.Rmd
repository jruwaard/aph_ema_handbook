...
```{r passiveema, echo = FALSE, out.width = '100%', fig.asp = .25, fig.align='center', fig.cap='Passive EMA: data are collected automatically, for instance by a wearable device such as the GENEActive accelerometer.'}
library(jpeg)
library(grid)
library(gridExtra)
library(ggplot2)
