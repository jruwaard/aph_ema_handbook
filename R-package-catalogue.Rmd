...
```{r GENEAread-example, message = FALSE, warning = FALSE, eval = TRUE, include=TRUE, results='hide'}
...
```{r genearead-example-kable, eval = TRUE, echo = FALSE}
knitr::kable(d[1:4, ], digits = 6)
```
...
```{r genearead-plot-example, out.with = "100%", fig.asp = .3, fig.cap = "Raw sensor data of a GENEActiv accelerometer.", message = FALSE, warning = FALSE}
...
```{r ggir-install-example, eval = FALSE}
library(devtools)
...
```{r GGIR-pdf, echo = FALSE, fig.cap = "sample GGIR output", out.width = '100%', fig.align = 'center', fig.asp = .4, fig.show = 'hold'}
knitr::include_graphics(c(
   "images/catalogue_R/GGIR_pdf.png"))
```
...
```{r fig15a, fig.cap="Activity Counts (5-minute windows), in a Three-day Accelerometer data set.", out.width = "100%", fig.asp = .4,  warning = FALSE, message = FALSE}
...
```{r autovarCore-example, eval = TRUE,  warning = FALSE, message = FALSE}
# Autovar analysis.
library(autovarCore)
...
```{r dplyr-example, message = FALSE, warning = FALSE}
...
```{r ggplot2-example, fig.cap = "Plotting layers with ggplot2", out.width = '45%', fig.asp = .4, fig.show = "hold",  warning = FALSE, message = FALSE}
...
```{r haven-example, warning = FALSE, message = FALSE}
# Read SPSS data
library(haven)
...
```{r lubridate-example, warning = FALSE, message = FALSE}
...
```{r nlme-example, warning = FALSE, message = FALSE}
...
```{r lme4-example, eval = TRUE,  warning = FALSE, message = FALSE}
# Fit a linear mixed model, with lme.
library(lme4)
...
```{r simr-example, warning = FALSE, message = FALSE}
...
```{r qgraph-example, out.width = "100%", fig.asp = .3, message = FALSE, warning = FALSE, fig.cap="Network of mood items from CSD data set"}
...
```{r qgraph-centrality-example, warning = FALSE, message = FALSE, out.width="100%", fig.asp = .3}
centralityPlot(g)
```
...
```{r bootnet-example, out.width = "100%", fig.asp = .4,  warning = FALSE, message = FALSE}
