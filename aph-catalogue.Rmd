...
| **Organization**     | AMC; Rijksuniversiteit Groningen |
...
| **OrganiZation**  | Vrije Universiteit Amsterdam; GGZ inGeest (and other organisations)|
...
| **Platform used** | Moodbuster (http://www.moodbuster.eu; see Chapter \@ref(ema-instruments-catalogue))) |
...
| **Organization** | VUmc, GGZ inGeest, Amsterdam|
...
| **Platform used** | RoQua (http://www.roqua.nl/), GENEActiv accelerometer. See Chapter \@ref(ema-instruments-catalogue)) |
...
| **Organization** | AMC (in collaboration with Ciro-Horn, Maastricht UMC, Radboud UMC, and Hasselt University) |
...
| **Organization** | Vrije Universiteit Amsterdam, VUmc, GGZ inGeest |
...
| **Organization** | Vrije Universiteit Amsterdam, VUmc, GGZ inGeest, Parnassia Psychiatric Institute
...
| **Organization** | VUmc, GGZ inGeest, the Netherlands Institute for Neuroscience |
