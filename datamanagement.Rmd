...
The full project, including example data and R-scripts, is available for download at
<https://drive.google.com/open?id=15TDS2k1NSlh8z1zEdObga4pcKkPhlOIG>. Download, unzip, and double-click the 'APH EMA Project.Rproj' file, to open the project in RStudio. Note that this is a large download (~134MB), because it contains large accelerometer data files.
