...
participants. Actigraphy data are high-volume data. These files are typically
large (500MB is no exception). By using the .bin format, in which data is
compressed, disk space is saved. Unlike the survey and EMA mood data, each data
file in this directory contains data of one participant. In this case, there are
even two files for one participant (APC009), perhaps because this participant
started the study with a faulty device, which was swapped during the study.
