...
\CommentTok{#> -1.94381 -0.58516  0.04387  0.48950  3.05005 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.53413    0.08780   6.084 2.39e-08 ***}
\CommentTok{#> depression.l1 -0.17096    0.08534  -2.003    0.048 *  }
\CommentTok{#> const         -0.05690    0.08557  -0.665    0.508    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.85 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.3017, Adjusted R-squared:  0.2871 }
\CommentTok{#> F-statistic: 20.74 on 2 and 96 DF,  p-value: 3.271e-08}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1:     1  7 14.58560 41.47346}
\CommentTok{#> 2:     2  7 19.43753 46.93242}
\CommentTok{#> 3:     3  7 10.81102 31.14380}
\CommentTok{#> 4:     4  7 17.49799 38.77780}
\CommentTok{#> 5:     5  7 17.50691 41.32916}
\end{Highlighting}
\end{Shaded}
