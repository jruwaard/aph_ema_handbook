...
Introduction, with Examples in R (1st edition - build 2018-11-17)}.
...
\index{Packages!GENEAread} \index{Packages!GGIR}
...
\NormalTok{out <-}\StringTok{ }\KeywordTok{capture.output}\NormalTok{(}
...
\CommentTok{#> -1.89839 -0.66056 -0.08484  0.76054  2.48846 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.50320    0.08474   5.938 4.59e-08 ***}
\CommentTok{#> depression.l1 -0.01553    0.08787  -0.177     0.86    }
\CommentTok{#> const         -0.08607    0.09551  -0.901     0.37    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.944 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.2705, Adjusted R-squared:  0.2553 }
\CommentTok{#> F-statistic:  17.8 on 2 and 96 DF,  p-value: 2.668e-07}
\end{Highlighting}
\end{Shaded}
...
be read into R. A particular advantage is that SPSS variables
definitions are retained (in attributes of the columns in the R
\texttt{data.frames}).
...
\section{simstudy}\label{simstudy}
...
\CommentTok{#> 1:     1  7 10.74207 28.41630}
\CommentTok{#> 2:     2  7 10.44255 27.97137}
\CommentTok{#> 3:     3  7 13.49877 33.02364}
\CommentTok{#> 4:     4  7 12.96595 28.31062}
\CommentTok{#> 5:     5  7 18.85833 40.79275}
\end{Highlighting}
\end{Shaded}
