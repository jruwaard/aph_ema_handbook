...
\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Pre-process and analyze raw multi-day\\
multi-day accelerometer data.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
...
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
**\textbar{} dplyr \textbar{} \textbar{}\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Data transformation.\\[2\baselineskip]\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
...
\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Automate the construction of vector\\
autoregressive models.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
\textbf{Mixed-effects Modeling}\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
lme4\\[2\baselineskip]\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Fit linear and nonlinear mixed-effects\\
models. Fast alternative to\\
package `nlme'.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
nlme\\[4\baselineskip]\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Fit linear and nonlinear mixed effects\\
models. Pre-dates package `lme4', but is\\
still used because it a provides more\\
advanced options to model correlational\\
structures in the data.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
**Power Analysis*\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
*\textbar{} simr \textbar{}\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Simulation-based power calculations for\\
mixed models.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
...
\textbf{Spatio-temporal analysis}\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
** \textbar{} adehabitatHR \textbar{} \textbar{}\strut
\end{minipage} & \begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
\textbar{} Developed for home range estimation of \textbar{} wild
animals from GPS data. Useful for \textbar{} human data as well.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
**Symptom Network\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
s** \textbar{} bootnet \textbar{}\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
Assess the stability of symptom\\
networks.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.32\columnwidth}\raggedright\strut
\strut
...
for unevenly sampled time series.\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\CommentTok{#> Processing took: 0.085 secs .}
...
\caption{Raw sensor data of a GENEActiv wrist-worn tri-axial accelerometer (down-sampled from 100Hz to 5Hz).}\label{fig:genearead-example}
\end{figure}
...
\CommentTok{#> -2.19318 -0.50293 -0.02582  0.59448  2.06502 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.56051    0.08640   6.488 4.04e-09 ***}
\CommentTok{#> depression.l1  0.01631    0.08619   0.189    0.850    }
\CommentTok{#> depression.l2 -0.02220    0.08759  -0.253    0.800    }
\CommentTok{#> const          0.11889    0.09230   1.288    0.201    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.9049 on 94 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.3133, Adjusted R-squared:  0.2914 }
\CommentTok{#> F-statistic: 14.29 on 3 and 94 DF,  p-value: 9.507e-08}
\end{Highlighting}
\end{Shaded}
...
\url{http://psychosystems.org/NetworkSchool}). Excellent introductions
in how to fit networks on R can also be found at
\url{http://sachaepskamp.com/files/Cookbook.html} and
...
the network. This is confirmed by the \texttt{centralityPlot}:
