...
research. With package \textbf{GENEAread} \citep[GENEAread]{R}, raw
...
Package \emph{GGIR} \citep{R-GGIR} is a package to process raw
...
development version, which is on GitHub.
...
and analysed. The example below shows an example configuration of this
...
\CommentTok{#> -2.24701 -0.66208  0.03378  0.65822  2.05743 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.58233    0.08606   6.767 1.11e-09 ***}
\CommentTok{#> depression.l1 -0.03764    0.08440  -0.446    0.657    }
\CommentTok{#> depression.l2  0.01846    0.08456   0.218    0.828    }
\CommentTok{#> const          0.11715    0.09299   1.260    0.211    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.9122 on 94 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.3286, Adjusted R-squared:  0.3072 }
\CommentTok{#> F-statistic: 15.33 on 3 and 94 DF,  p-value: 3.371e-08}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1:     1  7 14.89742 33.20295}
\CommentTok{#> 2:     2  7 10.20935 27.02771}
\CommentTok{#> 3:     3  7 13.77554 35.13268}
\CommentTok{#> 4:     4  7 18.50612 48.98011}
\CommentTok{#> 5:     5  7 17.66275 44.74252}
\end{Highlighting}
\end{Shaded}
