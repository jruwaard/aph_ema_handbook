...
Introduction, with Examples in R (1st edition - build 2018-11-20)}.
...
\CommentTok{#> -3.05080 -0.58418 -0.06736  0.55004  1.89357 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>                Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.511952   0.089347   5.730 1.15e-07 ***}
\CommentTok{#> depression.l1 -0.015223   0.089966  -0.169    0.866    }
\CommentTok{#> const         -0.007729   0.092572  -0.083    0.934    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.8926 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.255,  Adjusted R-squared:  0.2395 }
\CommentTok{#> F-statistic: 16.43 on 2 and 96 DF,  p-value: 7.306e-07}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1:     1  7 17.97807 43.00726}
\CommentTok{#> 2:     2  7 14.57202 37.21649}
\CommentTok{#> 3:     3  7 11.70117 30.40389}
\CommentTok{#> 4:     4  7 12.53885 36.75428}
\CommentTok{#> 5:     5  7 14.78020 34.44720}
\end{Highlighting}
\end{Shaded}
