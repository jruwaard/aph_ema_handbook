...
\KeywordTok{save}\NormalTok{(t0, }\DataTypeTok{file =} \StringTok{"data/cleaned/t0.Rda"}\NormalTok{)}
\KeywordTok{save}\NormalTok{(t0, }\DataTypeTok{file =} \StringTok{"data/cleaned/t1.Rda"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> -2.12417 -0.63067 -0.07466  0.70421  2.74190 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.73173    0.10257   7.134 1.84e-10 ***}
\CommentTok{#> depression.l1  0.01143    0.08263   0.138    0.890    }
\CommentTok{#> const          0.12207    0.09739   1.253    0.213    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.9416 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.3465, Adjusted R-squared:  0.3329 }
\CommentTok{#> F-statistic: 25.45 on 2 and 96 DF,  p-value: 1.352e-09}
\end{Highlighting}
\end{Shaded}
