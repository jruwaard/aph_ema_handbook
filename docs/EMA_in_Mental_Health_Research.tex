...
\CommentTok{#> Processing took: 0.178 secs .}
...
\CommentTok{#> -2.16684 -0.70663 -0.07416  0.55735  2.51048 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>               Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.50159    0.10708   4.684 9.25e-06 ***}
\CommentTok{#> depression.l1  0.14209    0.09166   1.550    0.124    }
\CommentTok{#> const          0.09227    0.10229   0.902    0.369    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 1.015 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.2048, Adjusted R-squared:  0.1882 }
\CommentTok{#> F-statistic: 12.36 on 2 and 96 DF,  p-value: 1.669e-05}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> }
\CommentTok{#> Time elapsed: 0 h 0 m 5 s}
\end{Highlighting}
\end{Shaded}
