...
\CommentTok{#> -2.3763 -0.7740  0.1084  0.6763  2.3256 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>                 Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.4308963  0.0919634   4.686 9.74e-06 ***}
\CommentTok{#> depression.l1  0.1237535  0.0960958   1.288    0.201    }
\CommentTok{#> depression.l2  0.0001138  0.0985318   0.001    0.999    }
\CommentTok{#> const          0.0123469  0.1012162   0.122    0.903    }
\CommentTok{#> outlier_43    -0.1040700  1.0234661  -0.102    0.919    }
\CommentTok{#> outlier_63     1.6619606  1.0187869   1.631    0.106    }
\CommentTok{#> outlier_74     0.0983524  1.0023439   0.098    0.922    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.9822 on 91 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.246,  Adjusted R-squared:  0.1963 }
\CommentTok{#> F-statistic: 4.949 on 6 and 91 DF,  p-value: 0.0002004}
\end{Highlighting}
\end{Shaded}
