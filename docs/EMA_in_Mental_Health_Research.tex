...
(identify non-wear periods, impute data) and analyzed (extract variables
on physical activity and sleep). The example below shows an example
configuration. See \texttt{?g.shell.GGIR} (and \texttt{?g.part1},
?\texttt{g.part2}, to \texttt{g.part4}) to learn the meaning of each
...
\CommentTok{#> -2.52626 -0.51668  0.00704  0.67312  2.48094 }
\CommentTok{#> }
\CommentTok{#> Coefficients:}
\CommentTok{#>                Estimate Std. Error t value Pr(>|t|)    }
\CommentTok{#> activity.l1    0.638778   0.087992   7.260 1.01e-10 ***}
\CommentTok{#> depression.l1 -0.082443   0.081824  -1.008    0.316    }
\CommentTok{#> const          0.007891   0.097905   0.081    0.936    }
\CommentTok{#> ---}
\CommentTok{#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1}
\CommentTok{#> }
\CommentTok{#> Residual standard error: 0.974 on 96 degrees of freedom}
\CommentTok{#> Multiple R-squared:  0.3737, Adjusted R-squared:  0.3606 }
\CommentTok{#> F-statistic: 28.64 on 2 and 96 DF,  p-value: 1.764e-10}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1:     1  7 15.09602 37.20751}
\CommentTok{#> 2:     2  7 17.72179 41.40412}
\CommentTok{#> 3:     3  7 13.00572 33.37782}
\CommentTok{#> 4:     4  7 10.86516 28.14085}
\CommentTok{#> 5:     5  7 13.91522 33.78071}
\end{Highlighting}
\end{Shaded}
