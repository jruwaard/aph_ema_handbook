...
#> -2.94174 -0.62562  0.04307  0.74161  1.95599 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> activity.l1    0.54394    0.10255   5.304 7.25e-07 ***
#> depression.l1 -0.07474    0.08959  -0.834    0.406    
#> const         -0.13614    0.10165  -1.339    0.184    
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> Residual standard error: 1.002 on 96 degrees of freedom
#> Multiple R-squared:  0.2374,	Adjusted R-squared:  0.2216 
#> F-statistic: 14.95 on 2 and 96 DF,  p-value: 2.234e-06
```
...
genData(5, def)
#>    idnum nr       x1       y1
#> 1:     1  7 11.02100 31.42493
#> 2:     2  7 17.04196 44.11825
#> 3:     3  7 12.61329 40.53750
#> 4:     4  7 10.76145 31.27595
#> 5:     5  7 16.09171 34.99778
```
