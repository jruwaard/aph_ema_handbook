...
#> -2.22880 -0.80031  0.04816  0.91103  2.80390 
#> 
#> Coefficients:
#>               Estimate Std. Error t value Pr(>|t|)    
#> activity.l1    0.50093    0.10507   4.767 6.64e-06 ***
#> depression.l1 -0.03111    0.09437  -0.330    0.742    
#> const         -0.17152    0.11314  -1.516    0.133    
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> Residual standard error: 1.114 on 96 degrees of freedom
#> Multiple R-squared:  0.1965,	Adjusted R-squared:  0.1798 
#> F-statistic: 11.74 on 2 and 96 DF,  p-value: 2.742e-05
```
