...
#> -2.66995 -0.61419  0.03166  0.75842  2.05816 
#> 
#> Coefficients:
#>                Estimate Std. Error t value Pr(>|t|)    
#> activity.l1    0.538784   0.101261   5.321 6.76e-07 ***
#> depression.l1 -0.008821   0.090391  -0.098    0.922    
#> const         -0.061040   0.099648  -0.613    0.542    
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> Residual standard error: 0.9887 on 96 degrees of freedom
#> Multiple R-squared:  0.2311,	Adjusted R-squared:  0.2151 
#> F-statistic: 14.43 on 2 and 96 DF,  p-value: 3.317e-06
```
