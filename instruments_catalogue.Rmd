...
```{r ilumivu, echo = FALSE, fig.cap = "Ilumivu App Screenshots", out.width = '30%', fig.align = 'center', fig.show = 'hold', fig.pos = "!t"}
...
```{r moodbuster, echo = FALSE, fig.cap = "MoodBuster App Screenshots", out.width='25%', fig.align = 'center', fig.show = 'hold', fig.pos = "!t"}
knitr::include_graphics(c(
...
```{r movisens, echo = FALSE, fig.cap = "Movisens Sample scheme editor (left) and App Screenshots (right)", out.width = '80%', fig.align = 'center', fig.show = 'hold', fig.pos = "!t"}
knitr::include_graphics(c(
...
```{r psymate, echo=FALSE, fig.cap = "PsyMate App Screenshots", out.width='25%', fig.align = 'center', fig.show = 'hold', fig.pos = "!t"}
knitr::include_graphics(c(
...
```{r roqua, echo = FALSE, fig.cap = "Screenshots of the participant feedback web-page of the 'HowNutsAreTheDutch' project, in which data is collected by the RoQua system", out.width='25%', fig.align = 'center', fig.show = 'hold', fig.pos = "!t"}
knitr::include_graphics(c(
...
```{r geneactiv, echo = FALSE, fig.cap = "The GENEActiv Accelerometer", out.width='100%', fig.align = 'center', fig.show = 'hold', fig.pos = "!h"}
