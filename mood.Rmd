...
```{r moodplot, fig.cap = "34 weeks of mood data, from a single participant"}
...
```{r moodplotcombined, fig.cap = "34 weeks of combined mood data, from a single participant"}
...
```{r circumplexrussel, fig.cap = "Russell's Circumplex model of affect.", echo = FALSE, out.width = '60%'}
...
```{r pickamood, fig.cap = "The Pick-A-Mood Circle.", echo = FALSE, out.width = '50%'}
...
```{r moodfa, fig.cap = "Factor analysis of scores of 9 EMA items, revealing two factors:  Positive Affect (PA) and Negative Affect (NA).", echo = FALSE}
