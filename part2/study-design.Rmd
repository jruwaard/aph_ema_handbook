...
The website http://cetool.nl/general/scanAid offers a quick scan that helps to determine whether an app of product should be classified as a medical device. Figure \@ref(fig:meddevflowchart) shows a flow-chart, based on these questions. 
