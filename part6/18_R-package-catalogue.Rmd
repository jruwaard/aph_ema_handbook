...
Many R packages exist that can help you in the management and analysis of EMA data. In this chapter, some of these packages are discussed. For each, we provide a summary description, and example code snippets. 
...
|                 |                   | \@ref(homerange)).                      | 
+-----------------+-------------------+-----------------------------------------+
| Symptom Networks| autovar           | Automate the construction of vector     |          
