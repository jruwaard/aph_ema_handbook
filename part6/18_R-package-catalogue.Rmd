...
```{r cs18b, fig.cap = "Plotting in layers with ggplot2", out.width = '45%', fig.show = "hold"}
# code snippet 18.2: demonstrating ggplot layers
...
# code snippet 18.3: demonstrating dplyr pipes
library(dplyr)
...
AutovarCore is a 'lean-and-mean' version of a more extensive package ***autovar*** [@[@R-autovarCore], which was used in several publications. [@VanderKrieke2015, @Emerencia2016]. Further information can be found on [http://autovar.nl](https://autovar.nl/) and [http://autovarcore.nl](https://autovarcore.nl/) 
